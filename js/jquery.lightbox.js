 ...
 * Originally written to make use of the Prototype framework, and Script.acalo.us, now altered to use $.
 *
 * This file was lightly modified by Ulf Benjaminsson (http://www.ulfben.com) for use in the WP $ Lightbox-
...
(function($){
	$.fn.lightbox = function(options){
	    ...
	    function initialize() {
			...
			outerImage += '<div id="imageContainer">';
				outerImage += '<iframe id="lightboxIframe" />';
				outerImage += '<img id="lightboxImage">';
				outerImage += '<div id="hoverNav"><a href="javascript://" title="' + opts.strings.prevLinkTitle + '" id="prevLink"></a><a href="javascript://" id="nextLink" title="' + opts.strings.nextLinkTitle + '"></a></div>';
				outerImage += '<div id="loading"><a href="javascript://" id="loadingLink"><div id="jqlb_loading"></div></a></div>';
				outerImage += '<a href="javascript://" id="showBig" class="jqlb_showbig" title="' + opts.strings.bigTitle + '">' + opts.strings.bigTitle + '</a>';
			outerImage += '</div>';
			outerImage += '</div>';

		    var imageData = '<div id="imageDataContainer" class="clearfix"><div id="imageData"><div id="imageDetails"><span id="caption"></span><div id="numberDisplay"></div></div></div></div>';
		    ...
		    $("#showBig").click(function(){   doChangeImage(temp=true); return false; });
	    ...
	    function getPageSize() {
		    var $PageSize = new Array($(document).width(),$(document).height(), $(window).width(), $(window).height());
		    return $PageSize;
	    };
	    ...
	    function resizeImageContainer(imgWidth, imgHeight) {
		    ...
		    if((hDiff == 0) && (wDiff == 0)){
			    if ($.browser.msie){ pause(250); } else { pause(100);}
		    }
